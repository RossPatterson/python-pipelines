...
class Stream(object):
  ...
  def sever(self, target=False): # disconnect current connection; restore stacked one if any
    if self.connections: # any stacked connctions?
      ...
      if self.side == 'out': 
        ...
        return self.streamList.decr() # let caller know # of streams still connected
